...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.Run.setGeometry(QtCore.QRect(0, 180, 791, 31))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "選擇欲拆解之貼圖"))
        self.chooseTexture.setText(_translate("Dialog", "選擇"))
        self.label_3.setText(_translate("Dialog", "選擇來源JSON"))
        self.chooseJSON.setText(_translate("Dialog", "選擇"))
        self.label.setText(_translate("Dialog", "選擇輸出資料夾"))
        self.JP.setText(_translate("Dialog", "JP"))
        self.zh_TW.setText(_translate("Dialog", "zh_TW"))
        self.Run.setText(_translate("Dialog", "輸出"))
        self.label_Image.setText(_translate("Dialog", "圖片位置"))
